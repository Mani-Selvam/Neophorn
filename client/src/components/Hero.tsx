...
const partnerLogos = [
  { name: "Acme Corp", src: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/stripe.svg" },
  { name: "Nebula", src: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/spotify.svg" },
  { name: "Quantum", src: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/slack.svg" },
  { name: "Future", src: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/notion.svg" },
  { name: "Global", src: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/google.svg" },
];
...
export function Hero({ onExploreClick }: HeroProps) {
  ...
  const circleScale = useTransform(scrollYProgress, [0, 1], [1, 50]);
  const circleOpacity = useTransform(scrollYProgress, [0, 0.5, 1], [1, 1, 0]);
  ...
  return (
    <div ref={containerRef} className="relative">
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#78b3f2]">
        ...
        <motion.div 
          className="fixed top-20 right-20 w-24 h-24 md:w-32 md:h-32 bg-zinc-900 rounded-full z-30 pointer-events-none origin-center"
          style={{ 
            scale: circleScale,
                ...
                >
                  ...
                  <div className="relative group">
                    ...
                    <motion.div 
                      ...
                      className="flex whitespace-nowrap items-center gap-12 py-2"
                    >
                      {[...partnerLogos, ...partnerLogos].map((logo, i) => (
                        <img 
                          ...
                          src={logo.src}
                          alt={logo.name}
                          className="h-8 w-auto opacity-40 hover:opacity-60 transition-opacity cursor-default invert"
                        />
                      ))}
                    </motion.div>
                  </div>
